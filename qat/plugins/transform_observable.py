...
class TransformObservable(AbstractPlugin):
    ...
    a fermionic class:`qat.fermion.Hamiltonian` or a :class:`qat.fermion.ElectronicStructureHamiltonian`
    into a spin :class:`qat.fermion.Hamiltonian`. The transformation is defined by a identifier (i.e. string)
