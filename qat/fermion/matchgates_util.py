...
def LDCA_cycle_routine(nb_fermionic_modes, theta_MG, theta_RZZ, slater=False):
    """
...
def LDCA_routine(nb_fermionic_modes, ncycles, theta, theta_gaussian=None, slater=False):
    """
    Full LDCA routine
